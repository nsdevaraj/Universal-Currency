package com.adams.currency.view.components
{
	...
	public class PropertyCompleteView extends SkinnableComponent
	{
		...
		private function addClickListener( event:FlexEvent ):void {
			...
			list.dataGroup.addEventListener( TouchEvent.TOUCH_TAP, listItemClick );
		}
		
		private function listItemClick( event:Object):void {
			acceptCompletion();
